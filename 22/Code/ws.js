...
class MyWebsocket extends EventEmitter {
    ...
    constructor(options) {
        ...
        server.on('upgrade', (req, socket) => {
            ...
            /**
             * （没看懂什么意思。。。）
             *  https://nodejs.cn/api/net/socket_setkeepalive_enable_initialdelay.html
             */
            ...
            /**
             * （没看懂什么意思。。。）
             * https://nodejs.cn/api/net.html#socketwritedata-encoding-callback
             */
